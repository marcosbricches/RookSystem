// src/app/planejamento-orcamentario/new/page.tsx
...
export default function NewPlanejamentoPage() {
  return (
    <div className="container mx-auto py-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Novo Planejamento</h1>
          <p className="text-muted-foreground mt-2">
            Preencha os dados do planejamento orçamentário
          </p>
        </div>
      </div>
        ...
        <TabsContent value="dados-principais">
          <div className="grid gap-6">
            ...
            <Alert>
              ...
              <AlertDescription>
                Para uma análise financeira mais precisa, preencha também as despesas operacionais na próxima aba.
              </AlertDescription>
            </Alert>
          </div>
        </TabsContent>
